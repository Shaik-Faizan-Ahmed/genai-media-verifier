...
/**
 * Learn Page Navigation Pill
 * Navigation for the Learn page sections
 */
export const LearnNavigationPill: React.FC = () => {
    ...
    const navItems: NavItem[] = [
        { label: 'Learn', sectionIndex: 0 },
        { label: 'Facial', sectionIndex: 1 },
        { label: 'Motion', sectionIndex: 2 },
        { label: 'Eyes', sectionIndex: 3 },
        { label: 'Lighting', sectionIndex: 4 },
        { label: 'Audio', sectionIndex: 5 },
        { label: 'Artifacts', sectionIndex: 6 },
        { label: 'Context', sectionIndex: 7 },
        { label: 'Our Approach', sectionIndex: 8 },
    ]
    ...
    const activeItem = navItems.find(item => item.sectionIndex === activeSection)
                ...
                {expanded && (
                    <div className="flex items-center justify-evenly w-full gap-1">
                        {navItems.map((item, index) => {
                            const isActive = item.sectionIndex === activeSection
